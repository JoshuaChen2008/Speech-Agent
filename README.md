...
| 本地非音频回归 | 联合验收完成 | core 410、integration 27、evidence 163，共 600 项。 |
| 远端 Windows CI 资格 | 实现完成·尚未验收 | provenance/workflow 资格链路已实现；revision `2242103…` 的 run `30750568366` 因 Electron runtime 未供给而在首个布局步骤失败，显式供给与前置校验修复为实现完成·尚未验收。 |
