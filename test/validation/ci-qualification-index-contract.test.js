...
test('SEM-T03 and J9-CI retain failed revisions, record the successful artifact, and freeze deterministic prerequisites', () => {
  ...
  assert.match(j9Ci, /30786324179/)
  assert.match(j9Ci, /c36aefaee4778a1bf2dfe1ee005924a724f4be53/)
  assert.match(j9Ci, /scripts\/i2-live-caption-player\.html/)
  assert.match(j9Ci, /i2PlaybackPageSha256/)
  assert.match(j9Ci, /最终索引按设计跳过/)
  assert.match(j9Ci, /30787209338/)
  assert.match(j9Ci, /f86ac1ef604dc7da0728c6eda44d59bbfd1e09bf/)
