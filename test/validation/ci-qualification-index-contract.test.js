...
test('SEM-T03 and J9-CI retain failed revisions, record the successful artifact, and freeze deterministic prerequisites', () => {
  ...
  assert.match(semantic, /30768637180/)
  assert.match(semantic, /2d3d6bdf5d745c15c239ef7503a0dfac211409a8/)
  assert.match(semantic, /8839812004/)
  assert.match(semantic, /3663225294fbd1019ab6e0e1e29608297fa767eb6c8e4b9012972fcd2d1f16c6/)
  assert.match(semantic, /9129794558c1f24f9300ba6f365a4b304a805fabe4f4e82691e77ea8cab19292/)
  assert.match(j9Ci, /exact checkout revision/)
  assert.match(j9Ci, /30768637180/)
  assert.match(j9Ci, /2d3d6bdf5d745c15c239ef7503a0dfac211409a8/)
  assert.match(j9Ci, /8839812004/)
  assert.match(j9Ci, /3663225294fbd1019ab6e0e1e29608297fa767eb6c8e4b9012972fcd2d1f16c6/)
