...
> **B5 制品边界：**当前 exact installer SHA-256 已冻结为 `5681f0173d3cbe8b516fb40cca03a2a1130f5e0826003e0a417b436c7ca58cc3`。它是未签名内部候选；本机 B5 已达到确定性联合验收完成，但不等于精确 release main 已在干净 Win11 上达到 I4 实机验收完成。
