...
| I2 真实来源与交互恢复 | 实现完成·尚未验收 | `run-i2-live-series.ps1`、`run-i2-interaction.ps1` | 具备真实 `loopback`/`mic`、设备控制权与睡眠权限的 Win11 | 是 | [`i2-real-source-series.md`](i2-real-source-series.md)、[`i2-live-b96b8fe-loopback/`](i2-live-b96b8fe-loopback/)、[`i2-interaction-recovery.md`](i2-interaction-recovery.md)；最近 `loopback` 五轮冻结 P95=1242ms | 保持 `<1000ms` 门槛并按六段 trace 定位；完成原生拖动、设备移除/Retry、睡眠/唤醒/Retry 与物理麦克风证据 |
