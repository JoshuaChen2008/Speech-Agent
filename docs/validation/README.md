...
| J9-CI 远端资格 | 实现完成·尚未验收 | [`.github/workflows/ci.yml`](../../.github/workflows/ci.yml) | GitHub Windows hosted runner | 否 | run `30761472817` 绑定 revision `811fc6d…`，已通过 Electron `43.2.0`、存储、四窗口产品壳、packaged 双启动、release NSIS 与隔离安装卸载，hidden artifact 已上传；末端 I3 模型 fixture 与文本 provenance 有 3 项可移植性失败 | 推送工作区内受控模型就绪证明 fixture 与 LF provenance 修复，取得成功 workflow 与 provenance artifact |
