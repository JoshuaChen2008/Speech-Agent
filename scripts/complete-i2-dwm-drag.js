...
function completionFromProgress ({ progress, confirmations, crossScaleObserved = false }) {
  ...
  if (progress.schemaVersion !== 6 || progress.state !== 'awaiting-operator-completion' ||
      progress.operatorCompletionObserved !== false) {
    throw new Error('DWM completion requires schema-v6 awaiting-operator-completion progress')
  }
