...
The authoritative I2 preflight is tracked at `docs/validation/i2-live-v4/gate-0c-preflight.json` with SHA-256 `43e97770e3508c88ff5843df2c897825f7e8b717bc1010fccb750c5beb2d1f0b`. The schema-v4 I2 runner validates each child and summary recursively; CI rebuilds the embedded summaries byte-for-byte from this exact Gate report and the 10 tracked child reports. Hosted CI verifies evidence integrity and does not replay or attest this machine's hardware.
